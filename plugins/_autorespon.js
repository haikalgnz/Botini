...
`.trim(), watermark, 'Pemilik Bot', ',owner', 'Cara memasukkan bot', '.how add', m)
    ...
    if (new Date() * 1 - setting.status > 1000) {
        ...
        await this.setStatus(`Aktif selama ${uptime} | Mode: ${global.opts['self'] ? 'Private' : setting.groupOnly ? 'Hanya Grup' : 'Publik'} | IKAL BOTZ oleh HAIKAL`).catch(_ => _) // disable jika kamu tidak suka dengan ini
